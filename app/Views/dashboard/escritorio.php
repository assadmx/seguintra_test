...
<section class="content">
    ...
    <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="../Respuestas/procesarRespuestas">
                    <input type="text" name="usuario" value="<?= $usuario ?>" required hidden>
                    <?php 
                        $respuestasModel = new \App\Models\RespuestasModel();
                        foreach ($preguntas as $pregunta) : ?>
                            <p><?= $pregunta['pregunta'] ?></p>
                            <?php 
                            $id_pregunta=intval($pregunta['id_pregunta']);
                            $opciones=$respuestasModel->encuentraRespuestas($id_pregunta); 
                            foreach ($opciones as $opcion) : ?>
                                <label for="<?= $opcion['id_respuestas'] ?>"><?= $opcion['respuesta'] ?></label>
                                <input type="radio" name="respuesta[<?= $pregunta['id_pregunta'] ?>]" value="<?= $opcion['id_respuestas'] ?>" required>
                            <?php endforeach; ?>
                        <?php endforeach; ?>
